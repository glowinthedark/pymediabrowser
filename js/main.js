                    ...
                    .then(data => {
                        ...
                        if (!iframe_head.length || !iframe_head.find('#flag_markdown').length) {
                            ...
                            iframe_head.append($("<link/>", {
                                rel: "stylesheet",
                                id: 'flag_markdown',
                                href: `/css/Torpedo.css`, // https://github.com/ttscoff/MarkedCustomStyles/blob/master/Torpedo.css
                                type: "text/css"
                            })).append($("<link/>", {
                                rel: "stylesheet",
                                id: 'flag_highlight',
                                href: `/css/atelier-estuary-light.css`,
                                type: "text/css"
                            }));
                        }
                        return data;
                ...
                fetch(contentLink)
                    ...
                    .then(data => {
                        ...
                        if (!head.length || !head.find('#flag_highlight').length) {
                            ...
                            .append($('<script/>', {
                                src: `/js/highlight.min-11.7.0.js`
                            }));
                        }
                        return data;
                    })
